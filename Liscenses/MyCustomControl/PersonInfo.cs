    ...
    public partial class PersonInfo: UserControl,ICustmControl<Person>
    {
        ...
        public static async Task<PersonInfo> CreateAsync()
        {
         PersonInfo personInfo = new PersonInfo();
            await personInfo.setcmb().ConfigureAwait(false);
            return personInfo;  
        }
        ...
        private async Task Loadx()
        {
            ...
            if (_person.PersonID >0)
            {
                ...
                if(!flag)
                    await setcmb().ConfigureAwait(false);
        ...
        private async void PersonInfo_Load(object sender, EventArgs e)
        {
            ...
            //pictureBox7.Image = Image.FromFile(@"C:\Users\dbhdh\Downloads\" + ((cmbGender.SelectedIndex == 0) ? "masculine.png" : "femenine.png"));
        ...
        //private void cmbGender_SelectedIndexChanged(object sender, EventArgs e)=> pictureBox7.Image = Image.FromFile(@"C:\Users\dbhdh\Downloads\" + ((cmbGender.SelectedIndex == 0) ? "masculine.png" : "femenine.png"));
