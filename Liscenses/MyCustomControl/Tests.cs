...
namespace Liscenses
{
    public partial class Tests : UserControl, ICustmControl<TestAppointment>
    {
        ...
        private void setTabpage2()
        {
            if (_testNum == 1)
            {
              //  pictureBox1.Image = Image.FromFile(@"C:\Users\dbhdh\Downloads\eye_open.png");
                lblTest.Text = "Viosn Test";
            }
            else if (_testNum == 2)
            {
               // pictureBox1.Image = Image.FromFile(@"C:\Users\dbhdh\Downloads\traffic_light.png");
                lblTest.Text = "Street Test";
            }
            else
            {
              //  pictureBox1.Image = Image.FromFile(@"C:\Users\dbhdh\Downloads\exam.png");
